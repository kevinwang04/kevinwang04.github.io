...
$(document).ready(function () {
    ...
    $(".interesting_wrap li").mouseover(function() {
        $(this).children("span").animate({
            top: "0px",
            backgroundColor: "rgba(116, 211, 168, 0.80)"
        });
    });
    $(".interesting_wrap li").mouseleave(function() {
        $(this).children("span").animate({
            backgroundColor: "rgba(116, 211, 168, 0.0)",
            top: "400px"
        });
    });
    ...
    $(".strong").mouseover(function() {
        $(this).css({
            "animation": "myfirst 2s ease-in 0 infinite",
            "-webkit-animation": "myfirst 2s ease-in 0 infinite"
        })
    });
});
